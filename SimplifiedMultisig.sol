...
contract Dex223_MultisigV2 {
    ...
    constructor (address _owner1, address _owner2, address _owner3, address _owner4, uint256 _vote_threshold) {
        require(
            ...
            _owner3 != address(0) && _owner4 != address(0),
            "Invalid owner address"
        );
        require(
            _owner1 != _owner2 && _owner1 != _owner3 && _owner1 != _owner4 &&
            _owner2 != _owner3 && _owner2 != _owner4 &&
            _owner3 != _owner4,
            "Owners must be unique"
        );
        require(_vote_threshold >= 2 && _vote_threshold <= 4, "Invalid threshold for 4 owners");
